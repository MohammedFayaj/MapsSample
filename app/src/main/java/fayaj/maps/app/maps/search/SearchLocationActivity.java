...
public class SearchLocationActivity extends AppCompatActivity
        implements NavigationView.OnNavigationItemSelectedListener,SearchLocationActivityContract.View {

    SearchLocationActivityContract.Presenter presenter;
    ...
    private void setPresenter() {
        presenter = new SearchLocationActivityPresenter(this,serviceManager);
        presenter.doSearch("Medavakam");
    }
    ...
    @Override
    public void getSearchResults(SearchResult searchResult) {
